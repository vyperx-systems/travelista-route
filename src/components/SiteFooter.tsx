...
export function SiteFooter() {
  return (
    <footer className="mt-16 bg-foreground text-cream/80">
      <div className="mx-auto flex max-w-[1240px] flex-col items-start justify-between gap-6 px-5 py-12 md:flex-row md:items-center md:px-8">
        <div>
          <div className="font-display text-[22px] italic text-cream">Saffron Atlas</div>
          <p className="mt-2 max-w-[42ch] text-[13px] text-cream/60">
            Slow journeys, told well. Hand-built itineraries across India and the world since 2016.
          </p>
        </div>
        <nav className="flex flex-wrap gap-x-7 gap-y-2 text-[13px] text-cream/70">

...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  useEffect(() => {
    // reportVyperXError(error, { boundary: "tanstack_root_error_component" });
  }, [error]);
  ...
  head: () => ({
    meta: [
      ...
      { title: "Tour & Travels — Tours & Travels" },
      {
        name: "description",
        content:
          "Hand-built domestic and international tour packages with day-wise itineraries, instant booking and INR pricing.",
      },
      { property: "og:site_name", content: "Tour & Travels" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", href: "/images/web_logo.png", type: "image/png" },

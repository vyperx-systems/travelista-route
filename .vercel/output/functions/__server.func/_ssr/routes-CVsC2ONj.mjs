...
import { _ as Headphones, a as ShieldCheck, f as MapPinned, o as Search, p as MapPin, r as Star } from "../_libs/lucide-react.mjs";
import { n as inr } from "./format-CRihJgk0.mjs";
import { a as fetchPackages, r as fetchApprovedReviews } from "./travel-Cw4W0a_v.mjs";
import { t as Skeleton } from "./skeleton-D9W9wFsj.mjs";
import { t as PackageCard } from "./PackageCard-BwS8mDY5.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CVsC2ONj.js
...
function Home() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "mx-auto max-w-310 px-5 py-14 md:px-8",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mb-6 flex flex-wrap items-end justify-between gap-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "label-mono text-primary",
					...
					className: "mt-2 text-[26px]",
					children: "What our travellers say"
				})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: "/reviews",
					className: "chip",
				...
				children: (reviews ?? []).slice(0, 3).map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("blockquote", {
					"data-reveal": true,
					style: { transitionDelay: `${i * 80}ms` },

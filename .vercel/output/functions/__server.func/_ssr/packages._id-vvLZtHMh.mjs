...
import { i as fetchPackageById, n as bookingSchema, o as itineraryOf, r as fetchApprovedReviews, s as listOf } from "./travel-Cw4W0a_v.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/packages._id-vvLZtHMh.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-4 grid gap-3",
					children: (reviews ?? []).length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-sm text-muted-foreground",
						children: [
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
								...
								children: r.author_name || "Traveller"
							})
						]
					}, r.id))
				})
